...
const getInitialAdvisorMessages = () => [
  {
    id: 'w-adv',
    role: 'assistant',
    text: 'يا أهلاً وسهلاً بك.. معك المستشار المعرفي ALHOOTAH، يسعدني جداً مرافقتك في رحلة الانتقال الإيجابي من وزارة الصحة إلى الشركة القابضة. هذه مرحلة جديدة ومثيرة، وأنا هنا لأساعدك في كل استفساراتك. تفضل، كيف يمكنني خدمتك اليوم؟ وممكن نتشرف باسمك الكريم؟',
    timestamp: new Date()
  }
];
...
const getInitialRepositoryMessages = () => [
  {
    id: 'w-repo',
    role: 'assistant',
    text: 'يا هلا فيك في مكتبتك الرقمية.. المستشار المعرفي ALHOOTAH جاهز لمساعدتك في تحليل واستخراج المعلومات من الوثائق. اختر المصدر اللي يهمك، وخليني أساعدك في فهم محتواه. ممكن نتشرف باسمك؟',
    timestamp: new Date()
  }
];
